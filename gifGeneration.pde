...
void SETUP__gifsMap(){
    ...
    gifFPSbySource = new HashMap<String, float[]>(){{
        ...
        put("Atreides_Rise.gif",            new float[]{5, 0.97, 0.25, 0.03});
        put("Atreides_siluette_2.gif",      new float[]{10, 0.92, 0.25, 0.03});
        put("Atreides_siluette.gif",        new float[]{5, 0.92, 0.25, 0.03});
        ...
        put("Stilgar.gif",                  new float[]{5, 0.95, 0.21, 0.03});
        put("Stilgar_Paul.gif",             new float[]{5, 0.95, 0.27, 0.03});
        put("Thumper.gif",                  new float[]{6, 0.95, 0.22, 0.03});
        put("Waiting for Worm.gif",         new float[]{6, 0.95, 0.23, 0.03});
    }};
